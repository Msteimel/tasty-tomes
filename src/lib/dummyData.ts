    ...
    notes: [
      {
        ...
        content: "I sift the flour for a lighter, fluffier cookie! It makes a huge difference in texture.",
      ...
      },
      {
        ...
        userId: "mike-chen",
        username: "Mike Chen",
        content: "I use Nielsen-Massey vanilla extract exclusively - the other brands just don't have the same depth of flavor. Worth the extra cost!",
    ...
    variants: [
      {
        ...
        userNotes: [
          {
            id: "note-variant-2-1-1",
            userId: "alex-martinez",
            username: "Alex Martinez",
            content: "These are incredibly rich! I reduce the sugar by 1/4 cup to balance the intensity of the dark chocolate.",
  ...
  },
  {
    ...
    notes: [
      ...
      },
      {
        ...
        userId: "emma-davis",
        username: "Emma Davis",
        content: "I mix Gruyère with a little Emmental cheese for a more complex flavor. Also, rubbing the bread with garlic before toasting is a game-changer!",
